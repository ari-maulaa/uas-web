@extends('layouts.app')
@section('title', 'Q-Semart - '.Auth::user()->nama)
@section('breadcrumb')
  <h1>Home</h1>
  <ol class="breadcrumb">
...
@section('content')
	<div class="col-sm-12">
		<div class="alert alert-info"><i class="fa fa-info-circle"></i> Hai <b>{{ Auth::user()->nama }}</b>, yuk gabung dengan komunitas pelajar sesama pengguna aplikasi Ti-Xam. Berlajar dan bertemu teman baru dari seluruh penjuru Tanah Air.</div>
	</div>
	<div class="col-md-8">
  ...
  <div class="col-md-4">
  	<div class="box box-warning">
	    ...
	    <div class="box-body">
	      <p>Hai <b>{{ Auth::user()->nama }}</b>, selamat datang di Q-Semart. Sekolah kamu telah menggadopsi teknologi teknologi untuk proses kegiatan belajar mengajar. Ini hal yang sangat bagus.</p>
	    </div>
	  </div>
  </div>
@endsection
