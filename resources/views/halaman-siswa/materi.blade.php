...
@section('breadcrumb')
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Materi Q-Semart</li>
  </ol>
@endsection
@section('content')
	<div class="col-md-8">
      ...
      <div class="box-footer" style="margin: 0; padding: 0 10px">
        <p class="text-muted">Materi disiapkan oleh <a href="https://Q-Semart.com" target="_blank">Q-Semart.com</a></p>
      </div>
    </div>
  </div>
  <div class="col-md-4">
  	<div class="box box-warning">
        ...
        <p>Kamu juga bisa akses langsung ke <a href="https://Q-Semart.com" target="_blank">Q-Semart.com</a> untuk mendapatkan informasi lebih lanjut.</p>
	    </div>
	  </div>
  </div>
@endsection
