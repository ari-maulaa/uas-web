...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{ url('/') }}" class="logo">
      ...
      <span class="logo-mini"><b>Q</b>Semart</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Q</b>Semart</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  {{ Auth::user()->nama }}
                  <small>Bergabung sejak __ 2020</small>
                </p>
              </li>
              <!-- Menu Body -->
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview {{ Request::is('elearning*') == true  ? 'active' : '' }}">
          <a href="#">
            <i class="fa fa-graduation-cap"></i> <span>Ujian Online</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020 Q-Semart .</strong> Teguh-Ari-Aqib.
  </footer>
</div>
<!-- ./wrapper -->
