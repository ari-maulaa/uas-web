...
@section('content')
  <div class="col-md-8">
    <div class="box box-primary">
      ...
      <div class="box-body">
        <p class="alert alert-info"><i class="fa fa-info-circle"></i> Fitur materi masih dalam tahap pengembangan. mohon maaf atas ketidaknyamanan ini</a>. Untuk itu, selalu pantau update dari saya yaa <i class="fa fa-smile-o" aria-hidden="true"></i>.</p>
      </div>
    </div>
  </div>
  <div class="col-md-4">
