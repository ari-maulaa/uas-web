...
@extends('layouts.app')
@section('title', 'Q-Semart - Aplikasi Ujian Online Berbasis Web')
@section('breadcrumb')
  <h1>Dashboard</h1>
  <ol class="breadcrumb">
  ...
  @if(Auth::user()->status == 'A' || Auth::user()->status == 'G')
    ...
    <div class="col-md-4">
      ...
      <div class="box box-warning">
        ...
        <div class="box-body">
          <p>Terimakasih telah menggunakan aplikasi ujian (<b>Q-Semart</b>) </p>
        </div>
      </div>
    </div>
  @else
    <div class="alert" style="background: #fff; border: solid thin #d8d5d5;">
      <p>Hai {{ Auth::user()->nama }}, Selamat datang di Q-Semart. Disini kamu bisa temukan materi yang telah disiapkan oleh Guru, kerjakan soal latihan dan ujian.</p>
